...
const apiSettingsSource = readFileSync("src/lib/api-settings.ts", "utf8");

assert.match(registerRouteSource, /credits:\s*appConfig\.features\.newUserCredits/);
assert.match(apiSettingsSource, /newUserCredits:\s*0/);
